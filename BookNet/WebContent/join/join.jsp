...
<!DOCTYPE html>
<!-- saved from url=(0139)https://nid.naver.com/user2/V2Join.nhn?token_sjoin=CrMVbMuUqJxRkOD4&chk_all=on&termsService=on&termsPrivacy=on&termsLocation=Y&termsEmail=Y -->
<html>
<head>
<meta charset="UTF-8">
...
<script type="text/javascript" src="/BookNet/js/clickcr.js"></script>
<style>
</style>
...
<div id="header" class="join_membership" role="banner">
    <h1><a href="http://www.naver.com/" class="h_logo"><span class="blind">로고</span></a></h1>
</div>
<!-- // header -->

<form id="join_form" method="post" action="https://nid.naver.com/user2/V2Join.nhn?m=end">
    ...
    <div id="container" role="main">
        <div id="content">
            ...
            <div class="join_content">
                ...
                <!-- // 휴대전화 번호, 인증번호 입력 -->
				<div class="join_row">
                	<h3 class="join_title"><label for="describe">간단소개</label></h3>
...
<script type="text/javascript" src="./네이버 _ 회원가입_files/rsaAll.js.다운로드"></script>
<script type="text/javascript" src="./네이버 _ 회원가입_files/lua.js.다운로드"></script>
<script type="text/javascript" src="./네이버 _ 회원가입_files/jquery.min.js.다운로드"></script>
<script type="text/javascript" src="./네이버 _ 회원가입_files/bvsd.1.3.4.js.다운로드"></script>
<script type="text/JavaScript">
    ...
    function createRsaKey() {
        var rsa = new RSAKey();
        var sessionKey = "C7Bqai3a41MKa7K3";
        var keyName = "100015403";
        var eValue = "";
        var nValue = "010001";
